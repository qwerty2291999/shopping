            ...
            <div class="container-fluid">
                <div class="list-count">
                    <ul>
                        <li>
                            <div class="icon">
                                <img src="../assets/imgs/5453183.png" alt="" />
                            </div>
                            <div class="text">
                                <h5>Products</h5>
                                <div class="count">
                        ...
                        <li>
                            <div class="icon">
                                <img
                                    src="../assets/imgs/img_290643.png"
                                    alt=""
                                />
                            </div>
                            <div class="text">
    ...
    methods: {
        ...
        async getAttribute() {
            try {
                const res = await axios.get(
                    `http://localhost:3000/admin/attribute`
                );
                this.attributeLenght = res.data.length;
            } catch (e) {
                console.log(e);
            }
        },
        async getCategory() {
            try {
                ...
                this.categoryLenght = res.data.length;
            } catch (e) {
                console.log(e);
            }
        },
        async getVoucher() {
            try {
                const res = await axios.get(
                    `http://localhost:3000/admin/voucher`
                );
                this.voucherLenght = res.data.length;
            } catch (e) {
                console.log(e);
            }
        },
